...
begin
  ...
  begin
    ...
    YC3:=HebYear1.YearCode.ToString(HebYear1.YearISLeapYear);
...
begin
  ...
  try
    ...
    begin
      ...
      HebYear.CalcNextYearsNewYearsDay;
      edtYearCode.Text:=HebYear.YearCode.ToString(HebYear.YearISLeapYear);
      Memo1.Lines.Add(k.ToString+' '+edtYearCode.Text);
